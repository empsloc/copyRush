...
function Preview() {
    ...
    return (
        <div>
            ...
            <div className="bg-[rgb(232,234,245)] space-y-5">
                <div className="space-y-5">
                    ...
                    <div className="flex justify-center">
                        <h1 className="text-3xl text-black font-bold mt-5">Print Out Preview</h1>
                    </div>

                    {/* List of files */}
                    <div className="listOfFile flex flex-row gap-5 overflow-x-auto whitespace-nowrap custom-scrollbar justify-center scroll-auto">

                        <DocumentPreview />

                        {/* Add more file card */}
                        <div
                            className="select-none w-45 h-60 flex flex-col bg-white hover:bg-green-100 hover:border-2 rounded-2xl justify-center items-center flex-none cursor-pointer"
                        >
                    ...
                    <div className="flex justify-center">
                        <Button
                            ...
                            className="bg-green-600 mt-5 mb-5 hover:bg-green-700 text-base font-medium text-white cursor-pointer"
                        >
            ...
            <div className="space-y-5">
                <div className="">
                    <h1 className="text-black text-xl font-bold mt-5">Print settings</h1>
