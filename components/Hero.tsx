...
export const Hero = (props: {}) => {
  return (
    <div className="div">
      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 grid grid-cols-2 bg-white">
      <div className="flex flex-col justify-center items-start gap-5">
        ...
        <div className="p-5 bg-[rgb(232,234,245)] rounded-xl">
      ...
      <div className="bg-[rgb(232,234,245)]  py-10">
        ...
        <div className=" mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8  grid grid-cols-4 space-x-5">
